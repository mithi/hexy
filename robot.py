...
class Hexapod(HexapodCore):
    ...
    def tilt_side(self, left_angle = 50, right_angle = 0, s = 0.1):
    ...
    def tilt(self, front_angle = 50, middle_angle = 25, back_angle = 0, s = 0.1):
    ...
    def lean_back(self, offset = 45, back_knee = 0, middle_knee = 40, raised = -30, s = 0.2):
        """ brings the back legs even further to the back and the middle legs to the front and then
            brings his front legs up in the air """ 
